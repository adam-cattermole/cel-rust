...
## [0.12.0](https://github.com/adam-cattermole/cel-rust/compare/v0.11.6...v0.12.0) - 2025-12-12
...
- default to BTree's instead of HashMap ([#231](https://github.com/adam-cattermole/cel-rust/pull/231))
- avoid cloning function args and name ([#228](https://github.com/adam-cattermole/cel-rust/pull/228))
- avoid double resolving single-arg func calls ([#227](https://github.com/adam-cattermole/cel-rust/pull/227))
- move
- minor tweaks to make usage more ergonomic
- Fix Context docstring to reference new_inner_scope instead of clone ([#221](https://github.com/adam-cattermole/cel-rust/pull/221))
